...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="w-full center fixed z-1000 top-0 p-5 pointer-events-none">
        <div className={` px-8 pointer-events-auto  transition-all duration-300 text-black ${openMenu ? "w-[45vw] rounded-2xl pb-8 bg-[#b7ab98]" : "w-[30vw] rounded-2xl bg-[#b7ab98]"} `}>
