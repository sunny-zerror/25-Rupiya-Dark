  ...
  return (
    <>
      <div className=" footer_paren w-full h-fit overflow-hidden relative">
        ...
        <div className=" footer_inner w-full padding py-5! pb-0! space-y-10 md:space-y-20 relative z-10 opacity-0 text-[#0d0d0d] ">
          ...
          <div className=" grid grid-cols-4 md:grid-cols-10 gap-x-20">
            ...
            <div className=" max-sm:mt-10  col-span-4 md:col-span-2 space-y-5">
              ...
              <div className=" flex flex-col font-medium space-y-1 capitalize">
                <Link href={"/"} className='flex items-center gap-x-1 group'> <span className='size-0 group-hover:size-1 transition-all duration-300 bg-black shrink-0 rounded-full'></span>+91 89898 98989</Link>
                <Link href={"/"} className='flex items-center gap-x-1 group normal-case'> <span className='size-0 group-hover:size-1 transition-all duration-300 bg-black shrink-0 rounded-full'></span>hello@25rupiya.com</Link>
                <Link href={"/"} className='flex items-center gap-x-1 group'> <span className='size-0 group-hover:size-1 transition-all duration-300 bg-black shrink-0 rounded-full'></span>2, Andheri West , Mumbai</Link>
              </div>
          ...
          <div className="w-full justify-between max-sm:space-y-2 md:flex items-center">
            ...
            <p className="font-semibold uppercase pp_neue text-xs">Developed by <Link href="https://www.zerrorstudios.com/" target='_blank' className='underline'> zerror studios</Link></p>
          </div>
